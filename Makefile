...
docker-build-all: 
    docker-build-ui docker-build-comment docker-build-post docker-build-prometheus docker-build-blackbox_exporter docker-build-mongodb_exporter docker-push-images
